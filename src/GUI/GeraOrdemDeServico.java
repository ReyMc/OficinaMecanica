 ...
 * @author goiar
 */
public class GeraOrdemDeServico extends javax.swing.JFrame {

    /**
     * Creates new form GeraOrdemDeServico
     */
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Gerar ordem de servico");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GeraOrdemDeServico.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GeraOrdemDeServico().setVisible(true);
            }
        });
    }
